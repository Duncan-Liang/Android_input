...
#qiancheng@wind-mobi.com 20160930 add start
ifeq ($(strip $(WIND_DEF_E280_ASUSSETTINGS)),yes)
    PRODUCT_PACKAGES += AsusSettings_E280L
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.asussettings=1
    $(call inherit-product-if-exists, packages/apps/AsusRes/asus_res.mk)
endif
#qiancheng@wind-mobi.com 20160930 add end

# sunhuihui@wind-mobi.com modify 2016/8/9 begin
ifeq ($(strip $(WIND_DEF_ENABLE_SCREEN_SOUND)),yes)
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.enable_screensound=1
else
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.enable_screensound=0
endif
# sunhuihui@wind-mobi.com modify 2016/8/9 end

#add by sunhuihui@wind-mobi.com 20160627 begin
ifeq ($(strip $(WIND_DEF_ASUS_USB_DIALOG)),yes)
   PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.asus_usb_dialog=1
endif
...
#sunhuihui@wind-mobi.com begin 20160713
...
#sunhuihui@wind-mobi.com end 20160713
...
ifeq ($(filter $(WIND_PROJECT_NAME_CUSTOM),E281L_WW E281L_ID E281L_TW D281L_WW D281L_ID D281L_TW D281L_US D281L_JP),)
...
#liyong01@wind-mobi.com add for 2016.06.29 begin
ifeq ($(strip $(WIND_WIFI_SERVER_CHANGE_CN)),yes)
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.wifi.server.change.cn=1
else
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.wifi.server.change.cn=0
endif
#liyong01@wind-mobi.com add for 2016.06.29 end
...
#qiancheng@wind-mobi.com 20160511 add start
ifeq ($(strip $(BUILD_GMS)), yes)
ifneq ($(filter $(WIND_PROJECT_NAME_CUSTOM),E281L_WW E281L_ID E281L_TW D281L_WW D281L_ID D281L_TW D281L_US D281L_JP),)
PRODUCT_PROPERTY_OVERRIDES += \
      ro.com.google.clientidbase=android-asus-wypm \
      ro.com.google.clientidbase.ms=android-asus-wypm \
      ro.com.google.clientidbase.yt=android-asus-wypm \
...
ifeq ($(strip $(WIND_DEF_ASUS_GSENSOR)),yes)
PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.asus.gsensor=1
endif
...
ifeq ($(strip $(WIND_DEF_ASUS_SYSTEMUI)),yes)
    ...
    #youxiaoyan@wind-mobi.com 20160629 for bug#116346 start
    ...
    #youxiaoyan@wind-mobi.com 20160629 for bug#116346 end
    endif
...
#zhenglihong@wind-mobi.com 20160509 start yutao@wind-mobi.com  20160616 modify x.xo to d.so 20160704 modefy d.so to x.so
ifeq (yes,$(strip $(AFS121_FINGERPRINT_ENABLE)))
ifeq (yes,$(strip $(TRUSTKERNEL_TEE_SUPPORT)))
			PRODUCT_PACKAGES += MaFactoryTest
else
			PRODUCT_PACKAGES += FprintTest
endif			
			PRODUCT_PACKAGES += fingerprintd
			PRODUCT_COPY_FILES += device/mediatek/mt6735/afs121/libfprint-x64.so:system/lib64/libfprint-x64.so
			PRODUCT_COPY_FILES += device/mediatek/mt6735/afs121/hw/fingerprint.default.so:system/lib64/hw/fingerprint.afs121.so
			PRODUCT_PROPERTY_OVERRIDES += ro.wind_fingerprint_enable=1
else 
			PRODUCT_PROPERTY_OVERRIDES += ro.wind_fingerprint_enable=0
endif
...
#pengfugen@wind-mobi-mobi.com 2016/07/20 start
ifeq ($(strip $(WIND_DEF_BOOT_DEL_CONTACTS)), yes)
    PRODUCT_PACKAGES += WindBootCmpDeleteCotacts
endif
#pengfugen@wind-mobi-mobi.com 2016/07/20 end
...
PRODUCT_PROPERTY_OVERRIDES += persist.asus.mupload.enable=1 \
		...
		ro.wind.def.asus_loguploader=1
PRODUCT_PACKAGES += \
    UtsBspLogCheck \
    LogUploader
endif
...
ifeq ($(strip $(WIND_DEF_ASUS_AVIOD_TOUCH)), yes)
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.aviod_touch = 1
else
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.aviod_touch = 0
endif
...
#zhangtao@wind-mobi.com add 2016/8/5 begain feature
PRODUCT_PROPERTY_OVERRIDES += ro.product.first_api_level=23
#zhangtao@wind-mobi.com add 2016/8/5 end feature
#pengfugen@wind-mobi.com for delete fingerprint begin
ifeq ($(strip $(WIND_DEF_FOTA_DEL_FINGER)), yes)
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.fota.del.finger = 1
else
    PRODUCT_PROPERTY_OVERRIDES += ro.wind.def.fota.del.finger = 0
endif
#pengfugen@wind-mobi.com for delete fingerprint end
#add by mohongwu@wind-mobi.com 20160830 begin
ifeq ($(strip $(MTK_BG_POWER_SAVING_SUPPORT)), yes)
	ifeq ($(strip $(MTK_BG_POWER_SAVING_UI_SUPPORT)), yes)
		PRODUCT_COPY_FILES += frameworks/base/core/java/com/mediatek/amplus/config/alarmplus.config:system/etc/alarmplus.config
	endif
endif
#add by mohongwu@wind-mobi.com 20160830 end
