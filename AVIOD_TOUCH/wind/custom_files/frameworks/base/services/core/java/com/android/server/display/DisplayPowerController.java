...
final class DisplayPowerController implements AutomaticBrightnessController.Callbacks {
    ...
    //add by mohongwu@wind-mobi.com 2016/7/27 begin
    private static final int PROXIMITY_SENSOR_POSITIVE_DEBOUNCE_DELAY_FOR_ASUS = 500;
    //add by mohongwu@wind-mobi.com 2016/7/27 end
    private static final int PROXIMITY_SENSOR_NEGATIVE_DEBOUNCE_DELAY = 250;
	//ranyanhao@wind-mobi.com 20160802 begin
	private static final int PROXIMITY_SENSOR_NEGATIVE_DEBOUNCE_DELAY_FOR_ASUS = 0;
	//ranyanhao@wind-mobi.com 20160802 end	
    ...
    //add by mohongwu@wind-mobi.com 2016/7/27 begin
    private static final boolean WIND_DEF_ASUS_AVIOD_TOUCH = SystemProperties.get("ro.wind.def.aviod_touch").equals("1");
    //add by mohongwu@wind-mobi.com 2016/7/27 end
        ...
        if (mProximitySensor != null) {
            if (mPowerRequest.useProximitySensor && state != Display.STATE_OFF) {
                ...
                if (mPowerRequest.useProximitySensor) {
                    ...
                    //liyong01@wind-mobi.com  add for Bug #102061 begin
                    if(mProximity == PROXIMITY_POSITIVE && state == Display.STATE_OFF){
                         mScreenOffBecauseOfProximity = true;
                         sendOnProximityPositiveWithWakelock();
                    }
                   //liyong01@wind-mobi.com  add for Bug #102061 end
                    setProximitySensorEnabled(true);
                } else {
    ...
    private void setProximitySensorEnabled(boolean enable) {
        if (enable) {
            ...
            if (mProximitySensorEnabled) {
                ...
                //add by mohongwu@wind-mobi.com 2016/7/27 begin
                if (WIND_DEF_ASUS_AVIOD_TOUCH){
                    PhoneWindowManager.mShouldTurnOffTouch = false;
                }
                //add by mohongwu@wind-mobi.com 2016/7/27 end
                mProximity = PROXIMITY_UNKNOWN;
    ...
    private void handleProximitySensorEvent(long time, boolean positive) {
        if (mProximitySensorEnabled) {
            ...
            if (positive) {
                ...
                //modify by mohongwu@wind-mobi.com 2016/7/27 begin
                //setPendingProximityDebounceTime(
                //        time + PROXIMITY_SENSOR_POSITIVE_DEBOUNCE_DELAY); // acquire wake lock
                if (WIND_DEF_ASUS_AVIOD_TOUCH){
                    setPendingProximityDebounceTime(time + PROXIMITY_SENSOR_POSITIVE_DEBOUNCE_DELAY_FOR_ASUS);
                }else {
                    setPendingProximityDebounceTime(
                            time + PROXIMITY_SENSOR_POSITIVE_DEBOUNCE_DELAY); // acquire wake lock
                }
				...
				//ranyanhao@wind-mobi.com 20160802 begin
						...
						time + PROXIMITY_SENSOR_NEGATIVE_DEBOUNCE_DELAY_FOR_ASUS);
				//ranyanhao@wind-mobi.com 20160802 end
            }
    ...
    private void debounceProximitySensor() {
        if (mProximitySensorEnabled
            ...
            if (mPendingProximityDebounceTime <= now) {
                ...
                //add by mohongwu@wind-mobi.com 2016/7/27 begin
                if (WIND_DEF_ASUS_AVIOD_TOUCH){
                    PhoneWindowManager.mShouldTurnOffTouch = true;
                }
                //add by mohongwu@wind-mobi.com 2016/7/27 end
